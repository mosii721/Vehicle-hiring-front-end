import { History, SquareUserRound, LogOut ,Bus} from "lucide-react";
...
function SideNav({ onSelect }: SideNavProps) {
  return (
    <ul className="menu bg-base-200 min-w-fit gap-2 text-base-content min-h-full">
      ...
      <li>
        <button onClick={() => onSelect('Me')}>
          <SquareUserRound /> Me
        </button>
      </li>
      <li>
        <button onClick={() => onSelect('Vehicles')}>
          <Bus /> Vehicles
        </button>
      </li>
      <li>
